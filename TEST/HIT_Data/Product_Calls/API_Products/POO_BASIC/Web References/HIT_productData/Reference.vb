...
Namespace HIT_productData
    ...
    Partial Public Class ProductControllerService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.POO_BASIC.My.MySettings.Default.POO_BASIC_HIT_productData_ProductControllerService
        ...
        Public Function getProductsBySubcategory(ByVal customerNumber As String, ByVal userCredential As String, ByVal subcategoriesIds() As Integer) As <System.Xml.Serialization.SoapElementAttribute("return")> Integer()
    ...
    Partial Public Class Category
        ...
        Private subcategoriesField() As Subcategory
        ...
        '''<remarks/>
        Public Property subcategories() As Subcategory()
            Get
