Public Class Form1
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim VendorImportID As Integer = -370
        ...
        Dim productId As String = "1001,1003,7156,2602,11001" '"1001" ',1003,7156,2602,11001" '"5000" 'Nothing '"30" ' "7050" ' "5000" ' , 1025" '"1025" '"2000" '"1001" '"5000" 'Nothing
        ...
        Dim Comment As String = "For Ingrid to test"

        Dim ExtractTask As String = "PROPERTY" '"PRODUCTINFO" '"CONFIGURATION"
