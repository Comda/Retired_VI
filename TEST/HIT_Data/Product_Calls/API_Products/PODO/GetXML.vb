Public Class GetXML
    ...
    Public Sub GetReplyData(ByVal ProductList As List(Of String), ByVal FunctionRequested As String)
        ...
        PODO = New HIT_productData.ProductControllerService
        ...
        Api_Para.SourceAPI = "http://ds.hitpromo.net/product"
        ...
        For i = 0 To ProductList.Count - 1
            ...
            Select Case FunctionRequested
                Case "GetProperties"
                    Try
                        Reply = PODO.getInfo(id, password, productId, False)
                    ...
                    If Not IsNothing(Reply) Then
                        Extract.GetPairsExtractFromReply(Reply)
                    End If
