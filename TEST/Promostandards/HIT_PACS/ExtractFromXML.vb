Public Class ExtractFromXML
    ...
    Public Sub GetConfigurationAndPricingExtractFromReply(Reply As HIT_PricingConfiguration.GetConfigurationAndPricingResponse)
        Try
                        ...
                        If Not IsNothing(Reply.Configuration.LocationArray(i2).DecorationArray) Then
                            For ii = 0 To Reply.Configuration.LocationArray(i2).DecorationArray.Length - 1
                                AddToDecorationArray(DecorationArray,
                                    ...
                                    Api_Para.CheckObject(Reply.Configuration.LocationArray(i2).DecorationArray(ii).rushLeadTime))
            ...
            AddRowsToPartArray(PartArray)
            AddRowsToPartPrice(PartPrice)
            AddRowsToPartLocationArray(PartLocationArray)
            AddRowsToLocationArray(LocationArray)
            AddRowsToDecorationArray(DecorationArray)
            AddRowsToChargeArray(ChargeArray)
            AddRowsToChargePriceArray(ChargePriceArray)
    ...
    Private Sub AddRowsToDecorationArray(ByRef InfoList As List(Of DecorationArray))
    ...
    End Sub
    Private Sub AddRowsToLocationArray(ByRef InfoList As List(Of LocationArray))
        ...
        End Try
    End Sub
    Private Sub AddRowsToChargePriceArray(ByRef InfoList As List(Of ChargePriceArray))
    ...
    Private Sub AddRowsToPartPrice(ByRef InfoList As List(Of PartPrice))
    ...
    Private Sub AddRowsToChargeArray(ByRef InfoList As List(Of ChargeArray))
    ...
    Private Sub AddRowsToPartArray(ByRef InfoList As List(Of PartArray))
    ...
    End Sub
    Private Sub AddRowsToPartLocationArray(ByRef InfoList As List(Of PartLocationArray))
