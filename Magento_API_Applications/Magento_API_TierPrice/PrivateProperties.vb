...
#Region "SQL Varialbles"
    ...
    Friend WithEvents GetTierPricesFromERP_da As Magento_StoreTableAdapters.GetTierPricesFromERPTableAdapter
    Friend WithEvents ProductFeedData_Buffer_DELETE As Magento_StoreTableAdapters.ProductFeedData_Buffer_DELETETableAdapter
