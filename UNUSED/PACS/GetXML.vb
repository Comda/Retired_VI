Public Class GetXML
    ...
    Public Sub GetReplyData(ByVal ProductList As List(Of String), ByVal FunctionRequested As String, ByVal Api_Para As Object)
        ...
        For i = 0 To ProductList.Count - 1
            ...
            Select Case FunctionRequested
                Case "GetConfigurationAndPricing"
                    ...
                    End Try
                    If Not IsNothing(Reply) Then
                        Extract.GetConfigurationAndPricingExtractFromReply(Reply, Api_Para)
                    End If
